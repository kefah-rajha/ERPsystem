...
exports.user = {
    getAllUsers: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const resallPost = yield schemaUser_1.UserModel.find().sort({
                createdAt: -1,
            });
    ...
    deleteUser: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            if (userDelete === null || userDelete === void 0 ? void 0 : userDelete._id) {
                const userContactDelete = yield schemaUser_1.UserModel.findByIdAndDelete(id);
                if (userContactDelete === null || userContactDelete === void 0 ? void 0 : userContactDelete._id) {
                    const userCompanyDelete = yield schemaUser_1.UserModel.findByIdAndDelete(id);
                    if (userCompanyDelete === null || userCompanyDelete === void 0 ? void 0 : userCompanyDelete._id) {
                        res.status(200).json({
