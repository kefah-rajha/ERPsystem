...
router.post("/products/getProducts/:pageNumber/:pageSize", products_1.products.getAllProducts);
...
router.get("/products/getNumberProducts", products_1.products.getNumberProducts);
