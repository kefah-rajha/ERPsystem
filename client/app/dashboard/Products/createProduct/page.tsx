...
import styleBlob from "@/cssCustom/backgroundBlob.module.scss";
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="mt-10">
          <div className="flex  w-full flex-col bg-background container">
            {/* <div className={styleBlob.blob_light} style={{width:"100px"}}></div> */}

            {/* <div className={styleBlob.blobContainer}>
    <div className={styleBlob.blob}></div>
    <div className={styleBlob.blob_one}></div>
    <div className={styleBlob.blob_two}></div>
    <div className={styleBlob.blob_three}></div>
    <div className={styleBlob.blob_four}></div>
    <div className={styleBlob.blob_five}></div>
    <div className={styleBlob.blob_six}></div>
    <div className={styleBlob.blob_seven}></div>
    </div> */}
