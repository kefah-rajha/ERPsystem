...
import FilterWareHouseProduct from "@/components/inventory/wareHouseProducts/filterWareHouseProduct"
...
export default function WareHouseProducts() {
  ...
  return (
    <div className="flex w-full flex-col    bg-gradient  relative">
          ...
          <Tabs defaultValue="all">
            ...
            <TabsContent value="all">
              <Card x-chunk="dashboard-06-chunk-0" className="shadow-md py-4">
                <CardHeader>
                  <CardTitle className={cn("font-bold text-[2rem]")}>
                    Products
                  </CardTitle>
