    ...
    const filterAndSearchHandler = async () => {
        ...
        const getData = async (pageNumber: number, pageSize: number, data: dataType) => {
            ...
            if (resProducts) {
                ...
                setWareHouses(resProducts?.appliedFilters?.warehouses)
        ...
        <div className="flex justify-start gap-2 ">
            ...
            >
               ...
               Reset Filter
                    ...
                    <div className="flex justify-between items-center gap-2">
                        <h3 className=" bg-[#595959] border-none h-8  w-fit text-[#A19D9D] rounded-sm px-2 flex justify-center items-center">Warehouse</h3>
                        ...
                        >
                            ...
                            <SelectContent>
                                ...
                                {warehouses.length > 0 && warehouses.map((warehouse: wareHouseType) => (
                                    <SelectItem
                                        key={warehouse._id}
                                        value={warehouse._id}
