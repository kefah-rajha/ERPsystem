...
function CreateContantInfo({ stepsHandle }: dataType) {
  ...
  async function onSubmit(dataForm: profileFormValues) {
    ...
    const updateDataProfileInfo = await UpdateContactInfo(
      dataForm,
      `/api/profile/contactInfo/${idNewUser}`
    );

    console.log(updateDataProfileInfo, "updateDataProfileInfo");
...
export default CreateContantInfo;
